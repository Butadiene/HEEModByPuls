...
std::int_fast32_t ManagePsdDataOnCoordinate::GetNumArrayFromCoordinateOnRealPsdArray(std::vector<int_fast32_t> num_focus_real_elements) const{
...
std::int_fast32_t ManagePsdDataOnCoordinate::GetNumArrayFromCoordinateOnAllPsdArray(std::vector<int_fast32_t> num_focus_real_elements,std::vector<int_fast32_t> num_focus_velocity_elements) const{
